...
class Airline{
private:
string Flight, Des, Dep;//Flight ,destination and departure
int Seats;
...
int main(){
Airline flight1("F101", "KTM", "London", 50);
Airline flight2("F202", "KTM", "NYC", 40);
Airline flight3("F303", "Pokhara", "KTM", 2);
